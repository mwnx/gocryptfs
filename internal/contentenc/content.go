...
// Splitting the ciphertext into more than X groups will not improve performance,
// as spawning goroutines comes at a cost. Let's try 4.
const encryptMaxSplit = 4
